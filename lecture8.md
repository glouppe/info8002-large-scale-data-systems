...
.width-80[![](figures/lec8/iceberg.png)]
...
<span class="Q">[Q]</span> Which file systems do you know?
...
- Data is too large be stored in a single system.
- Hardware **will** fail.
]
.kol-1-2.center[
...
<span class="Q">[Q]</span> As the cluster grows, can the master become a bottleneck?
...
<span class="Q">[Q]</span> How to fix the hotspot problem?<br>
